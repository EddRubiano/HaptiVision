        ...
        try:
            with SMBus(1) as bus:
                for i in range(count):
                    ...
                    sleep(0.008)  # Give sensor a small break
...
while True:
    ...
    for idx, (pos, delay, label) in enumerate(positions):
        ...
        if label == "1st": # Code to store the color values of each one of the zones for zone_colors dictionary
            ...
            count_2 = sum(1 for v in dist if v > 150) # Anything above a Trheshold, will be consider a GAP in front of the person if v > 150
        ...
        screen.blit(font3.render("Zone 1", True, GREY2), (1025, 200))
        screen.blit(font3.render("Zone 2", True, GREY2), (1135, 200))
        screen.blit(font3.render("Zone 3", True, GREY2), (1245, 200))
        screen.blit(font3.render("Zone 4", True, GREY2), (1025, 310))
        screen.blit(font3.render("Zone 5", True, GREY2), (1135, 310))
        screen.blit(font3.render("Zone 6", True, GREY2), (1245, 310))
        screen.blit(font3.render("Zone 7", True, GREY2), (970, 410))
        screen.blit(font3.render("Zone 8", True, GREY2), (1080, 410))
        screen.blit(font3.render("Zone 9", True, GREY2), (1190, 410))
